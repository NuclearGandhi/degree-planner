...
export const Logo: React.FC = () => {
  return (
    <div className="fixed top-4 left-4 z-50 p-3 bg-slate-200 bg-opacity-60 dark:bg-slate-800 dark:bg-opacity-70 rounded-lg shadow-lg flex items-center space-x-3">
