...
export const AveragesDisplay: React.FC<AveragesDisplayProps> = ({
  ...
  return (
    <div 
      dir="rtl" 
      className="fixed bottom-4 right-4 z-50 p-4 !bg-slate-50/60 dark:!bg-gray-800/60 rounded-lg shadow-md backdrop-blur-sm max-w-sm min-h-[250px]"
    >
      <h3 className="text-sm font-semibold mb-3 text-center !text-gray-700 dark:!text-gray-300">סיכום נק"ז וממוצע</h3>
