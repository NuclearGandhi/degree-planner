...
export const AveragesDisplay: React.FC<AveragesDisplayProps> = ({
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 p-4 bg-white bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-80 rounded-lg shadow-md backdrop-blur-sm">
      <h3 className="text-sm font-semibold mb-2 text-gray-700 dark:text-gray-300">Averages</h3>
